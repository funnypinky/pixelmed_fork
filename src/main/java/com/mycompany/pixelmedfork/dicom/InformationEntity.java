...
public class InformationEntity implements Comparable {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/InformationEntity.java,v 1.11 2012/02/01 23:02:09 dclunie Exp $";
	...
	public static InformationEntity fromString(String test) {
		if (test != null) {
			String name = test.toUpperCase(java.util.Locale.US);
