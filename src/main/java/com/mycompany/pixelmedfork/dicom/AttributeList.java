...
public class AttributeList extends TreeMap<AttributeTag,Attribute> {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeList.java,v 1.111 2012/03/26 10:24:01 dclunie Exp $";
...
//System.err.println("readOnlyMetaInformationHeader(): afterwards i.areReadingDataSet()="+i.areReadingDataSet());
	 ...
	 * @exception	DicomException
	 */
	public void read(DicomInputStream i,AttributeTag stopAtTag) throws IOException, DicomException {
//System.err.println("read(DicomInputStream i,AttributeTag stopAtTag="+stopAtTag+"):");
		read(i,i.getByteOffsetOfStartOfData(),0xffffffffl,false,null,stopAtTag);
	}
	...
	public void read(String name,String transferSyntaxUID,boolean hasMeta,boolean useBufferedStream) throws IOException, DicomException {
		read(name,transferSyntaxUID,hasMeta,useBufferedStream,null);
	}
	 ...
	 * @exception	DicomException
	 */
	public void read(String name,String transferSyntaxUID,boolean hasMeta,boolean useBufferedStream,AttributeTag stopAtTag) throws IOException, DicomException {
		InputStream i = null;
	 ...
	 * @exception	DicomException
	 */
	public void readOnlyMetaInformationHeader(String name) throws IOException, DicomException {
		InputStream i = null;
		DicomInputStream di = null;
		try {
	 ...
	 * @exception	DicomException
	 */
	public void read(String name,AttributeTag stopAtTag) throws IOException, DicomException {
		read(name,null,true,true,stopAtTag);
	}
	 ...
	 * @exception	DicomException
	 */
	public void read(File file,AttributeTag stopAtTag) throws IOException, DicomException {
		read(file.getCanonicalPath(),stopAtTag);
	}
	 ...
	 * @exception	DicomException
	 */
	public void readOnlyMetaInformationHeader(File file) throws IOException, DicomException {
		readOnlyMetaInformationHeader(file.getCanonicalPath());
	}
